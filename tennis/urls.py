...
urlpatterns = patterns('',
    ...
    (r'^organization/$', 'tennis.organizations.views.get_all_organizations'),
    (r'^organization/(?P<organization_id>\d+)/$', 'tennis.organizations.views.get_organization'),
...
#    (r'^admin/', include('django.contrib.admin.urls')),
    ...
    (r'^documents/(?P<path>.*)$', 'django.views.static.serve', {'document_root': '/home/tennis/media/documents'}),
)
